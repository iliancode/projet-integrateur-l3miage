...
/**
 * Cette classe correspond au handler d'exception rest. Ici, on catch l'exception {@link MailAlreadyUseRestException}<br>
 * Les annotations :
 * <ul>
...
@ControllerAdvice
@Slf4j
public class MailAlreadyUseExceptionHandler {

    /**
     * Cette classe correspond au handler de l'exception {@link MailAlreadyUseRestException}.<br>
     * Ici lorsque le code va lever l'exception {@link MailAlreadyUseRestException} alors la fonction <b color="blue">handle()</b> sera appelée.<br>
     * Les annotations :
     * <ul>
     ...
     * @return {@link ResponseEntity}<{@link MailAlreadyUseErrorResponse}></li>
     */
    @ExceptionHandler(MailAlreadyUseRestException.class)
    public ResponseEntity<ErrorResponse> handle(HttpServletRequest httpServletRequest, Exception exception){
        MailAlreadyUseRestException ex = (MailAlreadyUseRestException) exception;
        final MailAlreadyUseErrorResponse response = MailAlreadyUseErrorResponse.builder()
