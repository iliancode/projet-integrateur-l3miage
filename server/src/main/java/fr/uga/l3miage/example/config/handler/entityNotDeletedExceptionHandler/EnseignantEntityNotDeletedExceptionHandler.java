...
/**
 * Cette classe correspond au handler d'exception rest. Ici, on catch l'exception {@link EnseignantEntityNotDeletedRestException}<br>
 * Les annotations :
 * <ul>
...
@ControllerAdvice
@Slf4j
public class EnseignantEntityNotDeletedExceptionHandler {

    /**
     * Cette classe correspond au handler de l'exception {@link EnseignantEntityNotDeletedRestException}.<br>
     * Ici lorsque le code va lever l'exception {@link EnseignantEntityNotDeletedRestException} alors la fonction <b color="blue">handle()</b> sera appelée.<br>
     * Les annotations :
     * <ul>
     ...
     * @return {@link ResponseEntity}<{@link EnseignantEntityNotDeletedErrorResponse}></li>
     */
    @ExceptionHandler(EnseignantEntityNotDeletedRestException.class)
    public ResponseEntity<EnseignantEntityNotDeletedErrorResponse> handle(HttpServletRequest httpServletRequest, Exception exception){
        EnseignantEntityNotDeletedRestException ex = (EnseignantEntityNotDeletedRestException) exception;
        final EnseignantEntityNotDeletedErrorResponse response = EnseignantEntityNotDeletedErrorResponse.builder()
