...
/**
 * Cette classe correspond à l'erreur renvoyée au client lorsqu'un mail est déjà utilisée sur une autre entité, lors de la création ou l'update d'une entité<br>
 ...
 * </ul>
 */
@JsonTypeName(MailAlreadyUseErrorResponse.TYPE_NAME)
@EqualsAndHashCode(callSuper = true)
@Getter
@ToString(callSuper = true, exclude = "errorCodeSwaggerDocumentation")
public class MailAlreadyUseErrorResponse extends ErrorResponse {
    /**
     * Match {@link ErrorCode#MAIL_ALREADY_USE_ERROR}
     */
    protected static final String TYPE_NAME = "MAIL_ALREADY_USE_ERROR";
     ...
     * @param mail correspond au mail utilisé qui est en doublon.
     */
    @Builder
    @Jacksonized
    public MailAlreadyUseErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, String mail) {
