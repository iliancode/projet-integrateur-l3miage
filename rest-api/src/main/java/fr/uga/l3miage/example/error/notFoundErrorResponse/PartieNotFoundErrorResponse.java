...
import fr.uga.l3miage.example.error.errorResponse.PartieErrorResponse;
...
public class PartieNotFoundErrorResponse extends PartieErrorResponse {

    protected static final String TYPE_NAME = "PARTIE_IS_NOT_FOUND";
    ...
    @Builder
    @Jacksonized
    public PartieNotFoundErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, Long codePartie) {
