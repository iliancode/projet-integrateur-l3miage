...
public class EnseignantNotFoundErrorResponse extends EnseignantErrorResponse {
    ...
    @Schema(description = "le mail utilisé pour la recherche",example = "enseignant1@gmail.com")
    private final String mail;

    @Builder
    @Jacksonized
    public EnseignantNotFoundErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, String mail) {
